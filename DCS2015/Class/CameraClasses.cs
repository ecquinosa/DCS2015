...
namespace EDSDKLib
{
    ...
    public class SDKHandler : IDisposable
    {
        ...
        public void DownloadImage(IntPtr ObjectPointer, string directory)
        {
            ...
            PhotoFile = Path.Combine(directory, dirInfo.szFileName);            
            //string CurrentPhoto = DCS2015.Class.Utilities.PhotoRaw_FileName;            

            SendSDKCommand(delegate
            {
                //create filestream to data
                Error = EDSDK.EdsCreateFileStream(PhotoFile, EDSDK.EdsFileCreateDisposition.CreateAlways, EDSDK.EdsAccess.ReadWrite, out streamRef);
                //download file
        ...
        public Bitmap GetFileThumb(string filepath)
        {
            try
            {
                ...
                Error = EDSDK.EdsCreateFileStream(filepath, EDSDK.EdsFileCreateDisposition.CreateAlways, EDSDK.EdsAccess.Read, out stream);
        ...
        public void TakePhoto()
        {
            ...
            {
                DCS2015.Class.Utilities.ShowErrorMessage("TakePhoto encountered error");
            }
        }
        ...
        public void SetZoom()
        {
            //if (IsLiveViewOn) SendSDKCommand(delegate { Error = EDSDK.EdsSendCommand(MainCamera.Ref, , EDSDK.EvfZoom_x10); });
        }
