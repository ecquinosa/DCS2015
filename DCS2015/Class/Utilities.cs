...
namespace DCS2015.Class
{
    class Utilities
    {
        ...
        public static string CAPTUREDDATA_RAW_REPOSITORY = "";
        ...
        public static string MemberDataXML_FileName = "";
        public static string MemberDataSingleFile_FileName = "";

        public static string PhotoRaw_FileName = "";
        public static string PhotoFinal_FileName = "";

        public static string Signature_FileNameTIFF = "";
        public static string Signature_FileNameBMP = "";

        public static string BiometricLeftThumb_FileName = "";
        public static string BiometricLeftPrimary_FileName = "";
        public static string BiometricLeftMiddle_FileName = "";
        public static string BiometricLeftRing_FileName = "";
        public static string BiometricLeftPinky_FileName = "";

        public static string BiometricRightThumb_FileName = "";
        public static string BiometricRightPrimary_FileName = "";
        public static string BiometricRightMiddle_FileName = "";
        public static string BiometricRightRing_FileName = "";
        public static string BiometricRightPinky_FileName = "";

        public static string CaptureSessionReference = "";

        public static bool IsDataLoadedFromDraft = false;
        public static string LastSessionReferenceFileName = "LastSessionReference";
        ...
        public static string SessionReferencev1()
        {
            ...
            if (System.IO.File.Exists(LastSessionReferenceFileName))
            {
                if (Utilities.IsDataLoadedFromDraft) return System.IO.File.ReadAllText(LastSessionReferenceFileName);
                else return _sessionReference;
            ...
            {
                System.IO.File.WriteAllText(LastSessionReferenceFileName, _sessionReference);
                return _sessionReference;
            }
        }

        public static string SessionReferencev2()
        {
            //return string.Format("{0}_{1}_{2}",Properties.Settings.Default.StationReference.Trim(),DateTime.Now.ToString("yyyyMMdd"),(Properties.Settings.Default.CaptureCntr+1).ToString().PadLeft(4,'0'));
            string _sessionReference = string.Format("{0}_{1}_{2}", Properties.Settings.Default.StationReference.Trim(), DateTime.Now.ToString("yyyyMMdd_hhmmss"), (GetCaptureCntr() + 1).ToString().PadLeft(4, '0'));

            if (!Utilities.IsDataLoadedFromDraft) return _sessionReference;
            else 
            {
                if (!System.IO.File.Exists(LastSessionReferenceFileName))
                {
                ...
                {
                    string lastSessionReference = System.IO.File.ReadAllText(LastSessionReferenceFileName);
        ...
        public static void ResetSessionReferenceVariables()
        {
            ...
            CAPTUREDDATA_RAW_REPOSITORY = string.Format(@"{0}\RAW\{1}\{2}", Utilities.CAPTUREDDATA_REPOSITORY, DateTime.Now.ToString("MMddyyyy"), Utilities.CaptureSessionReference);
            if (!System.IO.Directory.Exists(CAPTUREDDATA_RAW_REPOSITORY)) System.IO.Directory.CreateDirectory(Utilities.CAPTUREDDATA_RAW_REPOSITORY);

            MemberDataXML_FileName = Utilities.CaptureSessionReference + ".xml";
            MemberDataSingleFile_FileName = Utilities.CaptureSessionReference;
            PhotoRaw_FileName = Utilities.CaptureSessionReference + "_Raw_Photo.jpg";
            PhotoFinal_FileName = Utilities.CaptureSessionReference + "_ICAO_Photo.jpg";
            Signature_FileNameTIFF = Utilities.CaptureSessionReference + "_Signature.tiff";
            BiometricLeftPrimary_FileName = Utilities.CaptureSessionReference + "_Lprimary";
            BiometricLeftThumb_FileName = Utilities.CaptureSessionReference + "_Lbackup";
            BiometricRightPrimary_FileName = Utilities.CaptureSessionReference + "_Rprimary";
            BiometricRightThumb_FileName = Utilities.CaptureSessionReference + "_Rbackup";
            DCS_MemberInfo.Data.SessionReference = Utilities.CaptureSessionReference;
            ...
            if (Properties.Settings.Default.ScanFingerType == 1)
            {
                BiometricLeftMiddle_FileName = Utilities.CaptureSessionReference + "_Lmiddle";
                BiometricLeftRing_FileName = Utilities.CaptureSessionReference + "_Lring";
                BiometricLeftPinky_FileName = Utilities.CaptureSessionReference + "_Lpinky";
                BiometricRightMiddle_FileName = Utilities.CaptureSessionReference + "_Rmiddle";
                BiometricRightRing_FileName = Utilities.CaptureSessionReference + "_Rring";
                BiometricRightPinky_FileName = Utilities.CaptureSessionReference + "_Rpinky";
            }
        }
