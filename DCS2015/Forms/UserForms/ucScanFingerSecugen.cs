...
{
    public partial class ucScanFingerSecugen : UserControl
    {
        public ucScanFingerSecugen()
        {
            InitializeComponent();
            txtQT.Text = Properties.Settings.Default.QualityThreshold_Secugen.ToString();
        }
        ...
        private void ucScanFingerSecugen_Load(object sender, EventArgs e)
        {
            CheckForIllegalCrossThreadCalls = false;

            System.Data.DataTable dtDevices=null;
            Class.Utilities.PopulateDevices(ref dtDevices);
            if (dtDevices.Select("DeviceName LIKE '*Secugen*'").Length == 0)
            {
                txtMsg.Text = "Unable to detect biometric device...";
                txtMsg.Visible = true;
                return;
            }
        ...
        private void Init()
        {
            ...
            {
                Utilities.BiometricCapturing_ErrorMessage = "Unable to initialize secugen device...";
            }            
        }

        private void ucScanFingerSecugen_Leave(object sender, EventArgs e)
        {
            _secugen = null;
            GC.Collect();
        }

        private void ucScanFingerSecugen_Resize(object sender, EventArgs e)
        {
        ...
        private void btnSequenceCapture_Click(object sender, EventArgs e)
        {
            ...
            Invoke(new Action(WaitForNextProcess));
        ...
        private void DisplayGIF(Utilities.SagemFingerID _SagemFingerID, Utilities.SagemFingerID _ActualFingerID)
        {
            ...
            switch (_SagemFingerID)
            {
                case Utilities.SagemFingerID.LeftIndex:                               
                    ...
                    this.pbBlinking.Image = Properties.Resources.left_hand___index_scan;                    
                    Application.DoEvents();                    
                ...
                case Utilities.SagemFingerID.LeftThumb:                                
                    ...
                    this.pbBlinking.Image = Properties.Resources.left_hand___thumb_scan;                    
                    Application.DoEvents();                    
                ...
                case Utilities.SagemFingerID.RightIndex:
                    ...
                    this.pbBlinking.Image = Properties.Resources.right_hand___index_scan;
                    Application.DoEvents();
                ...
                case Utilities.SagemFingerID.RightThumb:
                    ...
                    this.pbBlinking.Image = Properties.Resources.right_hand___thumb_scan;
                    Application.DoEvents();
        ...
        //private void SecugenCapture()
        //{
        //    _secugen.CaptureFingerprint();
        //}

        private new bool Capture(ref PictureBox pb, Label lbl, Utilities.SagemFingerID _FingerID, string fileJPG, string fileANSI378, string fileWSQ)
        {
            try
            {
                if (_secugen.CaptureFingerprint(_FingerID, fileJPG, fileANSI378, fileWSQ, Convert.ToInt32(txtQT.Text), ref pb))
                {                    
        ...
        private void vScroll_Quality_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            //_sagem = new Class.Sagem(ref display, ref textQuality, ref textStatus, (int)vScroll_Quality.Value);        
        }
